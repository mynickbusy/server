...
mp.events.add('render', (nametags) => {
	mp.game.graphics.drawText(`GTA5-MULTIPLAYER.RU BETA 0.1`, [0.5, 0.005], {
		font: 4,
		color: [255, 255, 255, 255],
		scale: [1,0.5],
		outline: true
...
mp.events.add('render', (nametags) => {
	mp.game.graphics.drawText(`E - Круиз контроль ВКЛ`, [0.06, 0.5], {
		font: 4,
		color: [255, 255, 255, 255],
		scale: [1,0.5],
		outline: true
...
mp.events.add('render', (nametags) => {
	mp.game.graphics.drawText(`LCtrl - Круиз контроль ВЫКЛ`, [0.0715, 0.53], {
		font: 4,
		color: [255, 255, 255, 255],
		scale: [1,0.5],
		outline: true
